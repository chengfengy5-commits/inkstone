...
export const ZH_CN_MESSAGES = {
    ...
    "learning.change_status": "修改“{title}”的学习状态",
    "learning.choose_status": "选择状态",
    "learning.description": "把已采集资料整理为待实践、学习中、待复习和已掌握的清晰队列。",
    "learning.empty_description": "带有“学习状态”标签的笔记会自动出现在这里。",
    "learning.empty_title": "还没有学习笔记",
    "learning.lane_attention": "需整理",
    "learning.lane_attention_description": "状态未知或存在冲突",
    "learning.lane_empty": "暂无内容",
    "learning.lane_learning": "学习中",
    "learning.lane_learning_description": "正在深入学习的主题",
    "learning.lane_mastered": "已掌握",
    "learning.lane_mastered_description": "已经完成的学习主题",
    "learning.lane_practice": "待实践",
    "learning.lane_practice_description": "等待动手验证的采集内容",
    "learning.lane_review": "待复习",
    "learning.lane_review_description": "需要再次巩固的主题",
    "learning.open_note": "打开「{title}」",
    "learning.review_date_update_failed": "无法更新复习日期",
    "learning.review_invalid": "日期无效",
    "learning.review_loading": "正在加载 {count} 篇复习笔记…",
    "learning.review_overdue": "已逾期",
    "learning.review_queue": "复习队列",
    "learning.review_today": "今天到期",
    "learning.review_unscheduled": "未安排",
    "learning.review_upcoming": "未来计划",
    "learning.schedule_review": "安排“{title}”的复习日期",
    "learning.status_update_failed": "无法更新学习状态",
    "learning.status_hint": "可在卡片上直接选择新状态",
    "learning.title": "学习工作台",
    "learning.total": "学习笔记",
