export const EN_US_MESSAGES = {
    ...
    "learning.change_status": "Change learning status for {title}",
    "learning.choose_status": "Choose a status",
    "learning.description": "Turn collected notes into a clear queue for practice, active learning, review, and mastery.",
    "learning.empty_description": "Learning notes appear here when they contain a Learning status tag.",
    "learning.empty_title": "No learning notes yet",
    "learning.lane_attention": "Needs attention",
    "learning.lane_attention_description": "Unknown or conflicting status tags",
    "learning.lane_empty": "Nothing here",
    "learning.lane_learning": "Learning",
    "learning.lane_learning_description": "Topics currently being studied",
    "learning.lane_mastered": "Mastered",
    "learning.lane_mastered_description": "Topics you have completed",
    "learning.lane_practice": "To practice",
    "learning.lane_practice_description": "Collected topics awaiting hands-on work",
    "learning.lane_review": "To review",
    "learning.lane_review_description": "Topics that should be revisited",
    "learning.open_note": "Open {title}",
    "learning.review_date_update_failed": "Could not update the review date",
    "learning.review_invalid": "Invalid date",
    "learning.review_loading": "Loading {count} review notes…",
    "learning.review_overdue": "Overdue",
    "learning.review_queue": "Review queue",
    "learning.review_today": "Due today",
    "learning.review_unscheduled": "Not scheduled",
    "learning.review_upcoming": "Upcoming",
    "learning.schedule_review": "Schedule a review for {title}",
    "learning.status_update_failed": "Could not update the learning status",
    "learning.status_hint": "Choose a status directly on any card",
    "learning.title": "Learning workbench",
    "learning.total": "Learning notes",
